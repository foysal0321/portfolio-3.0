    ...
    return (
        <div className='bg-[#232121] ' id='skills' >
            <div className='p-7 max-w-[1380px] mx-auto md:py-24 py-16 text-black" id="about' data-aos="fade-out">
                <div className='py-8'>
                <h2 className='md:text-5xl text-3xl font-extrabold py-2 text-gray-200'>Skills </h2>
                <p className="py-3 text-[18px]">
                    I have applied my skills in React, Node.js, MongoDB,  to successfully complete various projects, <br/> demonstrating my expertise in creating efficient and user-focused solutions.
                </p>
                </div>
